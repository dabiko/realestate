                ...
                $btnOptions = '
                               ...
                               <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="'.route(Auth::user()->role.'.property-detail.index', ['property' => $this->encryptId($query->id)]).'"> <i style="color:#0b6ce1;" class="fa-solid fa-circle-info"></i> Details</a>
                                 <a class="dropdown-item" href="'.route(Auth::user()->role.'.property-amenity.index', ['property' => $this->encryptId($query->id)]).'"> <i style="color:#0b6ce1;" class="fa-solid fa-snowflake"></i> Amenities</a>
                                ...
                                <a class="dropdown-item" href="'.route(Auth::user()->role.'.property-map.index', ['property' => $this->encryptId($query->id)]).'"> <i style="color:#0b6ce1;" class="fa-solid fa-map"></i> Map</a>
