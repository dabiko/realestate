...
class AgentPropertyDetailController extends Controller
{
    use EncryptDecrypt;
    /**
    ...
    public function index(PropertyDetailDataTable $dataTable)
    {
        ...
        return $dataTable->render('agent.property.detail.index',
            [
                'property' => $property,
    ...
    public function create():View
    {
        ...
        return View('agent.property.detail.create',
            [
                'property' => $property,
                'details' => $details,
    ...
    public function store(PropertyDetailCreateRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('agent.property-detail.index', ['property' => $validate['property_id']])
            ->with([
                'status' => 'success',
    ...
    public function edit(string $id): View
    {
        ...
        return view('agent.property.detail.edit',
            [
...
//            return Redirect::route('agent.property-detail.index', ['property' => ['property' => $validate['property_id'] ]])
//            ->with([
//                'status' => 'error',
