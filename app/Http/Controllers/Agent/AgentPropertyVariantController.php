...
class AgentPropertyVariantController extends Controller
{
    use EncryptDecrypt;
    /**
    ...
    public function index(Request $request, PropertyVariantDataTable $dataTable)
    {
        ...
        return $dataTable->render('agent.property.variant.index',
            [
                'property' => $property,
    ...
    public function create(Request $request): View
    {
        ...
        return View('agent.property.variant.create',
            [
                'property' => $property
            ]
        );
    ...
    public function store(PropertyVariantCreateRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('agent.property-variant.index', ['property' => $validate['property_id']])
            ->with([
                'status' => 'success',
    ...
    public function edit(string $id): View
    {
        ...
        return view('agent.property.variant.edit',
            [
                'variant' => $variant,
    ...
    public function update(PropertyVariantUpdateRequest $request, string $id): RedirectResponse
    {
        ...
        return Redirect::route('agent.property-variant.index', ['property' => $this->encryptId($property_id->property_id)])
            ->with([
                'status' => 'success',
