...
class AgentPropertyGalleryController extends Controller
{
    use EncryptDecrypt;
    ...
    public function index(Request $request, PropertyGalleryDataTable $dataTable)
    {
        ...
        return $dataTable->render('agent.property.gallery.index',
            [
                'property' => $property,
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return Redirect::route('agent.property-gallery-index',
