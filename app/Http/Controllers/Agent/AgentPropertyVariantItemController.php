...
class AgentPropertyVariantItemController extends Controller
{
    use EncryptDecrypt;
    ...
    public function index(PropertyVariantItemDataTable $dataTable, $propertyId, $variantId)
    {
        ...
        return $dataTable->render('agent.property.variant-item.index',
            [
                'property' => $property,
                'variant' => $variant,
    ...
    public function store(PropertyVariantItemCreateRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('agent.variant-item.index',
    ...
    public function edit(string $id): View
    {
        ...
        return view('agent.property.variant-item.edit',
            [
