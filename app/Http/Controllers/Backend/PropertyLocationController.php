...
class PropertyLocationController extends Controller
{
    ...
    public function index(PropertyLocationDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.property.location.index',
            [
                'property' => $property,
    ...
    public function create():View
    {
        ...
        return View('admin.property.location.create',
            [
                'property' => $property,
    ...
    public function store(PropertyLocationCreateRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin.property-location.index', ['property' => $validate['property_id']])
            ->with([
                'status' => 'success',
