...
class PropertyFacilityItemController extends Controller
{
    use EncryptDecrypt;
    /**
    ...
    public function index(PropertyFacilityItemDataTable $dataTable, $propertyId, $facilityId)
    {
        ...
        return $dataTable->render('admin.property.facility.item.index',
            [
                'property' => $property,
    ...
    public function create( $propertyId,  $facilityId): View
    {
        ...
        return View('admin.property.facility.item.create',
            [
                'property' => $property,
                'property_facility' => $property_facility,
            ]
    ...
    public function store(PropertyFacilityItemCreateRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin.facility-item.index',
    ...
    public function edit(string $id): View
    {
        ...
        return view('admin.property.facility.item.edit',
            [
