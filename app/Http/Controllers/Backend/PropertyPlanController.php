...
class PropertyPlanController extends Controller
{
    ...
    public function index(PropertyPlanDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.property.plan.index',
            [
                'property' => $property,
    ...
    public function create(): View
    {
        ...
        return View('admin.property.plan.create',
            [
                'property' => $property,
    ...
    public function store(PropertyPlanCreateRequest $request): RedirectResponse
    {
        ...
        $imagePath = $this->uploadPlanImage($request,'image', 'upload/property/plan');
        ...
        return Redirect::route('admin.property-plan.index', ['property' => $validate['property_id']])
            ->with([
                'status' => 'success',
    ...
    public function edit(string $id): View
    {
        ...
        return view('admin.property.plan.edit',
            [
    ...
    public function update(PropertyPlanUpdateRequest $request, string $id): RedirectResponse
    {
        ...
        $imagePath = $this->updatePlanImage($request, 'image', 'upload/property/plan', $old_path->image);
