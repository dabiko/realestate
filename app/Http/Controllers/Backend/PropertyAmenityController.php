...
use App\Http\Requests\Backend\PropertyAmenityUpdateRequest;
...
class PropertyAmenityController extends Controller
{
    ...
    public function index(PropertyAmenityDataTable $dataTable)
    {
        ...
        return $dataTable->render('admin.property.amenity.index',
            [
                'property' => $property,
    ...
    public function store(PropertyAmenityCreateRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin.property-amenity.index', ['property' => $validate['property_id']])
            ->with([
                'status' => 'success',
     ...
     */
    public function update(PropertyAmenityUpdateRequest $request, string $id)
    {
        //
    }
