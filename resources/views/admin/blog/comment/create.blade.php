...
@section('title')
    {{ config('app.name') }} | Create Blog Post
@endsection
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Create Blog Post</h4>
        </div>
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('admin.blog-post.index')}}">Blog Post Table</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <form
                        id="postForm"
                        method="POST"
                        action="{{route('admin.blog-post.store')}}"
                    ...
                    >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('tag') is-invalid @enderror" name="tags[]" id="tags" value="Real estate,">
                                @error('tag')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
