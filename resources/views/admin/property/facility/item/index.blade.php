...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{route('admin.property-facility.index', ['property' => request()->propertyId])}}">
            ...
            <a href="{{route('admin.property-facility-item.create', ['propertyId' => request()->propertyId, 'facilityId' => request()->facilityId])}}">
                <button type="button" class="btn btn-outline-primary btn-icon-text me-2 mb-2 mb-md-0">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('body').on('click', '.change-status', function (event){
                ...
                $.ajax({
                    url: "{{route('admin.property-facility-item.change-status')}}",
                    method: 'PUT',
                    data: {
                        status: isChecked,
                        id: id,
