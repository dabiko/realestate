            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @if (Route::currentRouteName() === 'admin.property.message')
                            @include('admin.property.messages.partials.messages')
                        @elseif(Route::currentRouteName() === 'admin.message.details')
                            @include('admin.property.messages.partials.details')
                        @endif
