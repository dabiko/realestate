<div class="col-lg-9">
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap px-3 py-2 border-bottom">
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="#" class="text-body me-2">{{$details->agent->name}}</a>
    ...
    <div class="p-3">
        ...
        <div class="mb-3 text-center"><h4>Agent Info</h4></div>
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    <th><b>Phone : </b></th>
                    <td>{{empty(!$details->agent->phone) ? $details->agent->phone : 'Not Provided'}}</td>
                </tr>
                </tbody>
            </table>
        </div>
