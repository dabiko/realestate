...
@section('content')
    ...
    <div class="row profile-body">
        ...
        @if ( Route::currentRouteName() === 'agent.profile')

            @include('agent.profile.partials.profileUpdate')

        @else

            @include('agent.profile.partials.passwordUpdate')
