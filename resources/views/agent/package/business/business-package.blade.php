...
@section('title')
    {{ config('app.name') }} | Business Packages
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="container-fluid w-100">
                        <a href="{{route('agent.process.business')}}" class="btn btn-primary float-end mt-4 ms-2"><i data-feather="send" class="me-3 icon-md"></i>Buy Package</a>
