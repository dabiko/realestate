...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{route('agent.property-facility.index', ['property' =>  Crypt::encryptString($property_facility->property_id)])}}">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('agent.property-facility.index', ['property' => Crypt::encryptString($property_facility->property_id)])}}">Facility Table</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <form
                        id="propertyForm"
                        method="POST"
                        action="{{route('agent.property-facility.update', Crypt::encryptString($property_facility->id))}}"
