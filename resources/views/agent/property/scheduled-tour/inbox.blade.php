            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="email-aside-nav collapse">
                                <ul class="nav flex-column">
                                    <li class="nav-item active">
                                        <a class="nav-link d-flex align-items-center" href="{{route('agent.property-schedules.messages')}}">
                                            <i data-feather="inbox" class="icon-lg me-2"></i>
                                            Inbox
                                            <span class="badge bg-danger fw-bolder ms-auto">{{count($tour_messages)}}
                                        </a>
                                    </li>
                        ...
                        @if (Route::currentRouteName() === 'agent.property-schedules.messages')
                            @include('agent.property.scheduled-tour.partials.messages')
                        @elseif(Route::currentRouteName() === 'agent.property-schedules.details')
                            @include('agent.property.scheduled-tour.partials.details')
                        @endif
