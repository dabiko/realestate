...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{route('agent.variant-item.index', ['propertyId' => Crypt::encryptString($variant_item->property_id), 'variantId' => Crypt::encryptString($variant_item->id)])}}">
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form
                        method="post"
                        action="{{ route('agent.variant-item.update', Crypt::encryptString($variant_item->id)) }}"
