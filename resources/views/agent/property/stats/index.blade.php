...
@section('title')
    {{ config('app.name') }} | {{$property->name}} Statistics
@endsection
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">{{$property->name}} Statistics</h4>
        </div>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form
                        method="post"
                        action="{{ route('agent.property-stats.store') }}"
                    ...
                    >
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="image" class="form-label">{{ __('Statistic Image') }} | <code>Multiple Image Supported*</code></label>
                                    ...
                                    <tr>
                                        <td colspan="100%" style="text-align: center;">
                                            <div class="alert alert-primary" role="alert">
                                                ...
                                                <strong>Oops No Data Available!!! </strong> Add Statistics images
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
