...
@section('content')
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route('agent.property-location.index', ['property' => request()->property])}}">Plan  Table</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <form
                        id="propertyForm"
                        method="POST"
                        action="{{route('agent.property-location.update',  Crypt::encryptString($property_location->id))}}"
                    >
