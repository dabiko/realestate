            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                    <div class="default-sidebar property-sidebar">
                        @include('frontend.pages.partials.filter')
                                    ...
                                    <div class="deals-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                ...
                                                <div class="buy-btn"><a href="{{route('agent.listing', ['purpose' => $property->purpose, 'agent' => Crypt::encryptString($property->user_id)])}}">For {{$property->purpose}}</a></div>
                                            </div>
