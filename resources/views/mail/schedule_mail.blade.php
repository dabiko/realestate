        ...
        <div class="bee-row-content">
            ...
            <div class="bee-col bee-col-2 bee-col-w5">
                ...
                <div class="bee-block bee-block-2 bee-heading">
                    <h1 style="color:#199e59;direction:ltr;font-family:'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:74px;font-weight:700;letter-spacing:normal;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">Homes<br/> </h1>
                </div>
    ...
    <div class="bee-row bee-row-5">
        <div class="bee-row-content">
            ...
            <div class="bee-col bee-col-2 bee-col-w8">
                <div class="bee-block bee-block-1 bee-paragraph">
                    <p><strong>Hell Sir </strong><br/>
                        <strong>Your Request is confirm on this data. </strong>
                    </p>
                    <p>Tour date: {{$schedule['tour_date']}}</p>
                    <p>Tour time : {{$schedule['tour_time']}}</p>
                    <p>{{$schedule['tour_message']}}<br/></p>
                </div>
            ...
            <div class="bee-col bee-col-1 bee-col-w12">
                <div class="bee-block bee-block-1 bee-text">
                    <div class="bee-text-content" style="line-height: 120%; font-size: 12px; font-family: inherit; color: #868686;">
                        <p style="font-size: 14px; line-height: 16px; text-align: center;"><span style="font-size: 12px; line-height: 14px;">@php date('Y') @endphp © All Rights Reserved</span></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="bee-block bee-block-1 bee-icons">
                    <div class="bee-icon bee-icon-last">
                        <div class="bee-content">
                            <div class="bee-icon-image"><a href="" target="_blank" title="Designed with BEE"><img alt="Designed with BEE" height="32px" src="images/bee.png" width="auto"/></a></div>
                            <div class="bee-icon-label bee-icon-label-right"><a href="" target="_blank" title="Designed with BEE">Designed with BEE</a></div>
                        </div>
                    </div>
                </div>
            </div>
